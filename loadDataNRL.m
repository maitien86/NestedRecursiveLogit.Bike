...
file_linkIncidence = './Input/IncidenceNRLAllObsConnectedNetwork.txt'; %matrix of all possible state transitions (1 if transition between 2 states is possible, 0 else)
file_observations = './Input/TripsObservationsNRLAllObsConnectedNetwork.txt';
file_linkAttributes = './Input/fullLinksAttsNRLAllObsConnectedNetwork.txt';
file_linkAttributes2 = './Input/LinkIDs.xlsx';
...
BikeFacilityDummy(nbRealStates)=0; %add zeros to fake links which connect network
noBikeFacilityDummy(nbRealStates)=0;
...
if isLinkSizeInclusive == true
    load('/home/zimmae/Documents/RL2.6.DeC.GLS/LSatt.mat');
end
